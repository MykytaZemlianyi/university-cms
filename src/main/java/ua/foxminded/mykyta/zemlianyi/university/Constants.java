...
public class Constants {
    ...
    public static final String USER_UPDATE_FAIL_DOES_NOT_EXIST = " update error - user was not saved in the database earlier";
    public static final String USER_PASSWORD_CHANGE_ERROR = " doesn't exists in database - unable to change password";
    public static final String USER_DELETE_ERROR = " delete error - user was not saved in the database earlier";
